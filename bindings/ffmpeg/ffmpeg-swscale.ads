-- bindings/ffmpeg/ffmpeg-swscale.ads
-- Ada bindings for libswscale (FFmpeg)
-- Covers: YUV → RGB pixel format conversion
...
package FFmpeg.SWScale is
   ...
   function sws_getContext
     (Src_W      : int;
      ...
      Dst_Format : int;
      Flags      : int;
      Src_Filter : System.Address;
      Dst_Filter : System.Address;
      Param      : System.Address) return SwsContext_Ptr
   with Import, Convention => C, External_Name => "sws_getContext";

   function sws_scale
     (Ctx        : SwsContext_Ptr;
      Src_Slice  : FFmpeg.AVUtil.Data_Plane_Array;
      Src_Stride : FFmpeg.AVUtil.Linesize_Plane_Array;
      Src_Slice_Y : int;
      Src_Slice_H : int;
      Dst        : FFmpeg.AVUtil.Data_Plane_Array;
      Dst_Stride : FFmpeg.AVUtil.Linesize_Plane_Array) return int
