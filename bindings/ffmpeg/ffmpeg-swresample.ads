-- bindings/ffmpeg/ffmpeg-swresample.ads
-- Ada bindings for libswresample (FFmpeg)
-- Audio resampling: any sample rate / format → SDL-required format
...
package FFmpeg.SWResample is
   ...
   --  Channel layouts
   -- ─────────────────────────────────────────────
   AV_CH_LAYOUT_STEREO : constant unsigned_long := 3;
   AV_CH_LAYOUT_MONO   : constant unsigned_long := 4;
